...
var City = function () {
    ...
    _createClass(City, [{
        ...
        value: function render() {
            var data = this.datas;
            var str = "";
            var listC = document.querySelector(".c-listC");
            for (var i in data) {
...
var Cons = function () {
    ...
    _createClass(Cons, [{
        ...
        value: function dom() {
            ...
            datas.forEach(function (value, ind) {
                function num(a, b) {
            ...
            var matterss = document.querySelector(".matter");
            var shou = document.querySelector(".shou");
            var sho = document.querySelector(".sho");
            var dls = sho.querySelector(".dls");
            var sex = dls.querySelector(".sex");
            var lists = void 0;

            setTimeout(function () {
                lists = dls.querySelectorAll("dl");
                for (var _i = 0; _i < lists.length; _i++) {
                    lists[_i].onclick = function () {
                        //点击dl将数据传递过去
                        var h3 = this.querySelector(" dd h3").innerHTML;
                        var span = this.querySelectorAll(" dd p")[2].querySelector("span").innerHTML;
                        var str = this.querySelectorAll(" dd p")[0].innerHTML + "级酒店";
            ...
            var matter = document.querySelector(".matter .dlss .dls");
            var matters = document.querySelector(".matter .dlsss .dls");

            matter.innerHTML = str;
            matters.innerHTML = str;
            sex.innerHTML = str;

            var i = document.querySelectorAll(".sho .orders i");
            var footer = document.querySelector(".footers");
            var orderss = document.querySelector(".orderss");
            var as = footer.querySelectorAll("a");
            var orders = document.querySelector(".orders");

            //点击footer下的列表进行选择  排序
            for (var _i2 = 0; _i2 < as.length; _i2++) {
                as[_i2].onclick = function () {
                    if (!this.classList.contains("o")) {
                        for (var k = 0; k < as.length; k++) {
                            as[k].classList.remove("o");
                        }
                        var num = this.getAttribute("footer") * 1 * 25;
            ...
            Array.from(i).forEach(function (v, i) {
                ...
                v.onclick = function () {
                    ...
                    if (v.className == "i") {
                        ...
                        //删除数组中的str
                        var num = obj.district.indexOf(district);
                        var xings = obj.xing.indexOf(xing);

                        if (district == null) {
                            obj.xing.splice(xings, 1);
                        } else {
                            obj.district.splice(num, 1);
                        }
                    } else {
                        v.innerHTML = "&#xe6e2;";
                        v.className = "i";
            ...
            //编写函数 进行筛选
            function sreen(obj) {
                var dlsDl = dls.querySelectorAll("dl");
                for (var _i4 = 0; _i4 < dlsDl.length; _i4++) {

                    dlsDl[_i4].style.display = "block";

                    for (var ind in obj) {
                        if (ind == "price") {
                            if (obj.price > dlsDl[_i4].getAttribute("price")) {
                                dlsDl[_i4].style.display = "none";
                            }
                            ...
                            if (obj[ind].length == 0) {} else {
                                if (obj[ind].indexOf(dlsDl[_i4].getAttribute(ind)) < 0) {
                                    dlsDl[_i4].style.display = "none";
                                }
                            }
                        }
...
var Banner = function () {
    ...
    _createClass(Banner, [{
        ...
        value: function render() {
            ...
            var data = this.datas;
            var str = "";
            var banner = document.querySelectorAll(".swiper-wrapper")[0];
            var banners = document.querySelector(".twoban");
            var zhe = document.querySelector(".lunbo .swiper-wrapper");
        ...
        value: function dom() {
            ...
            var cont = document.querySelector(".contts");
            var title = cont.querySelector(".title");
            var cSpan = title.querySelector("span");
            var ci = title.querySelector("i");
            var tims = document.querySelectorAll(".list li strong");

            var matter = document.querySelector(".matter");
            var shou = document.querySelector(".shou");

            var maList = matter.querySelectorAll(".ma-olist li");

            var iPhone = document.querySelector(".iPhone");
            var iPhones = document.querySelectorAll(".iPhone li");
            var maLists = document.querySelectorAll(".ma-lists strong");
            var yuding = document.querySelector(".yuding");

            var remove = yuding.querySelector(".remove");
            var mark = yuding.querySelector(".mark");
            var cSpans = matter.querySelector(".title span");
            var cis = matter.querySelector(" .title i");
            var ems = document.querySelectorAll(" .title em");

            for (var _i = 0; _i < ems.length; _i++) {
                ems[_i].onclick = function () {
                    time.className = "shows";
                };
            }

            for (var _i2 = 0; _i2 < maLists.length; _i2++) {
                maLists[_i2].onclick = function () {
            ...
            var i = document.querySelector(".c-list span i");
            var s = document.querySelector(".c-list span");

            setTimeout(function () {
                var s1 = document.querySelectorAll(".c-listC span");
                var s2 = document.querySelectorAll(".conts li");
                var strong = document.querySelectorAll(".list  strong");
                var cListS = document.querySelectorAll(".c-list  li strong");

                function click(ele) {
                    for (var _i3 = 0; _i3 < ele.length; _i3++) {
                        ele[_i3].onclick = function () {
            ...
            var dYuding = document.querySelector(".dYuding");
            var dDanbao = document.querySelector(".dDanbao");
            var yesla = document.querySelector(".yesla");

            var dYudingSpan = document.querySelectorAll(".dYuding .button span");
            var dDanbaoSpan = document.querySelectorAll(".dDanbao .button span");
            var yesList = document.querySelectorAll(".yesla .yesList li");
            ...
            var dYi = dYuding.querySelector(".title span");
            var dYe = dYuding.querySelector(".title i");
            ...
            list[0].onclick = function () {
                city.className = "show";
                var heightTop = document.querySelectorAll(".conts h2");
                var height = {};
                Array.from(heightTop).forEach(function (value, index) {
                    height[value.getAttribute("alpha")] = value.offsetTop;
                });
                var s = document.querySelectorAll(".c-listA span");
                Array.from(s).forEach(function (value, index) {
                    var citys = document.querySelector(".show");
    ...
    _createClass(Times, [{
        ...
        value: function dom() {
            ...
            var y = void 0,
                m = void 0;
            var data = new Date();
            var dat = data.getDate(); //日
            y = data.getFullYear(); //年
            m = data.getMonth();

            var head = document.querySelectorAll(".times .header a");
            var chekIn = document.querySelectorAll(".footer strong");
            var btn = document.querySelectorAll(".footer strong button");
            var ipt = document.querySelector(".footer strong input");
            var tims = document.querySelectorAll(".list li strong");
            var time = document.querySelector(".time");
            ...
            setTimeout(function () {
                ...
                var over = document.querySelector(".time .overs");
                var ipt = document.querySelector(".footer strong input");
                ipt.value = 1;
                ...
                btn[0].onclick = function () {
                    var over = document.querySelector(".overs");
                    if (ipt.value > 0) {
                        ipt.value--;
                    }
                ...
                yes.onclick = function () {
                    ...
                    time.className = "time";
                    var tims = document.querySelectorAll(".list li strong");
                    var ms = over.querySelector("span").innerHTML * 1 + ipt.value * 1;
                    var dat = new Date(y, m, ms);
                    ...
                    var emss = document.querySelectorAll(".title");
            ...
            function day(y, m, days, dat) {
                ...
                var timm = document.querySelector(".timm");
...
var _shouye = __webpack_require__(4);

var _city = __webpack_require__(1);

var _citys = __webpack_require__(2);

var _time = __webpack_require__(7);

var _conts = __webpack_require__(3);
...
(0, _ajax.ajax)({
    ...
    success: function success(data) {
        new _shouye.Banner(data);
        setTimeout(function () {
            new _swiper.Swiper(".banner", {
                autoplay: 1000,
                loop: true
            });
            new _swiper.Swiper(".banners", {
                autoplay: 1000,
                loop: true
            });
            var matter = document.querySelector(".matter");
            var banners = matter.querySelector(".banners");
            banners.onclick = function () {
                var zhe = document.querySelector('.zhe');
                zhe.style.display = "block";
                new _swiper.Swiper(".lunbo", {
                    autoplay: 1000,
                    loop: true
                });
...
btn.onclick = function () {
    ...
    (0, _ajax.ajax)({
        ...
        success: function success(data) {
            new _conts.Cons(data.data);
            donghua.style.display = "none";

            var list_main = document.querySelector('.sho .dls');
            var list_mains = list_main.querySelector('.sex');
...
(0, _slideSelector.element)('.room-count').addEventListener('click', function () {
    var ele = this.querySelector('.icon');
    selector.show({
        list: [1, 2, 3, 4, 5, 6],
        callback: function callback(data) {
            ele.innerHTML = data;
            var info_list = (0, _slideSelector.element)('.fill-order-info-box');
            var str = '';
...
(0, _slideSelector.element)('.check-in-time').onclick = function () {
    var ele = this.querySelector('.icon');
    selector.show({
...
(0, _slideSelector.element)('.rooms').onclick = function () {
    var ele = this.querySelector('.icon');
    selector.show({
...
(0, _slideSelector.element)('.roomss').onclick = function () {
    var ele = this.querySelector('.icon');
    selector.show({
        list: ['身份证', '驾驶证', '护照证'],
        callback: function callback(data) {
